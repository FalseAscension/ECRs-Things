function ecr_BackgroundContainer() {
    ...
    registerBlockType('ecr/background-container', {
        ...
        edit: function(props) {
            ...
            return [
                ...
                el('div', {className: props.className, style: { backgroundColor: `rgb(${props.attributes.background_color.r}, ${props.attributes.background_color.g}, ${props.attributes.background_color.b})`, color: props.attributes.foreground_color } },
                    el(InnerBlocks) 
                )
            ];
        },
