...
function ecr_EventDetails(){
    ...
    registerBlockType('ecr/event-details', {
        title: 'Event Details',
        icon: 'calendar-alt',
        category: 'common',
        supports: {
        ...
        attributes: {
            location: {
                type: 'string',
                source: 'meta',
                meta: 'ecr_event_details_location'
            },
            postcode: {
                type: 'string',
                source: 'meta',
                meta: 'ecr_event_details_postcode'
            },
            eventStart: {
                type: 'string',
                source: 'meta',
                meta: 'ecr_event_details_start',
                default: moment().format("DD-MM-YYYY HH:mm:ss")
            },
            eventEnd: {
                type: 'string',
                source: 'meta',
                meta: 'ecr_event_details_end',
                default: moment().format("DD-MM-YYYY HH:mm:ss")
            }
        },
